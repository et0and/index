  ...
  return (
    ...
    >
      ...
      <motion.div variants={slide} className="flex flex-col gap-2">
        <span>Today</span>
        <span className="text-muted">
          Working on Whim, a new haven for creators. Creating daily explorations
          on my {""}
          <ParagraphLink
      ...
      <motion.div variants={slide} className="flex flex-col gap-2">
        ...
        <span className="text-muted">
          ...
          />{" "}
          to support me and my work. If you are interested in owning a piece of
          my work, you can check out my pursuits into generative art on {""}
          <ParagraphLink
  ...
  return !icon ? (
    ...
    <div className="inline-flex gap-1">
      <a
        href={link}
        target="_blank"
        className="text-primary underline inline-flex gap-1 items-center size-fit h-[15px]  translate-y-[2.5px]"
      >
        {icon}
        {text}
      </a>
