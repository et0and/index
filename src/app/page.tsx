...
export default function Home() {
	...
	return (
		<div className="relative h-screen w-screen">
			<div className="mx-auto flex h-screen w-screen max-w-[512px] items-center justify-center p-4 text-justify">
				<motion.article
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
					exit={{ opacity: 0 }}
					...
					<section className="flex flex-col gap-2">
						...
						<div className="text-muted-foreground">
							...
							<UnderlinedLink
								...
								space="lr"
							/>
							to support me and my work and gain exclusive content. If you are
							interested in owning a piece of my work, you can check out my pursuits
							into art on
							<UnderlinedLink
								text="Zora"
